...
call node -v
if errorlevel 1 echo. && echo You must have node.js installed, install from https://nodejs.org/en/ && pause && goto :EOF
...
call pkg -v
if errorlevel 1 echo. && echo Package is not currently installed... install with "npm install -g pkg" or from https://www.npmjs.com/package/pkg && pause && goto :EOF
